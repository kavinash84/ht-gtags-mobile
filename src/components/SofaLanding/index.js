...
@connect(({ sofalanding }) => ({
  sofalanding,
  textBanner: sofalanding.data.items.text.textBanner,
  bedBanner: sofalanding.data.items.text.bedBanner,
  stripes: sofalanding.data.items.text.stripes,
  offerBanner: sofalanding.data.items.text.offerBanner,
  duracucine: sofalanding.data.items.text.duracucine,
  bankOffer: sofalanding.data.items.text.bankOffer,
  whyUs: sofalanding.data.items.text.whyUs,
  store: sofalanding.data.items.text.store,
  solidbeds:sofalanding.data.items.text.solidbeds
}))
class SofaLandingContainer extends Component {
...
export default SofaLandingContainer;