          ...
          <Row ml="0" mr="0" justifyContent="flex-start">
            <Div pt="0px" width="45%" style={{ float: 'none', width: '45%' }}>
              ...
              <Link to="/" style={{ display: 'flex', alignItems: 'center', height: '100%' }}>
                ...
                <Img float="left" height="35px" ml="-10px" src={LogoIcon} alt="Hometown" />
              </Link>
            </Div>
        ...
        {this.state.showNav ? (
          ...
          >
            ...
            <Div mt="20px">
              ...
              <Div pb="15px" pl="25px" pt="15px">
                <Link to="/modular-kitchens/" target="_blank">
                  <Text style={{ letterSpacing: '1.28px' }}>DuraCucine</Text>
                </Link>
              </Div>
              <Div pb="15px" pl="25px">
              ...
              <Div pb="15px" pl="25px">
                <Link to="/who-we-are">
                  <Text style={{ letterSpacing: '1.28px' }}>Help and Support</Text>
                </Link>
              </Div>
              <Div pb="15px" pl="25px">
                <Link to="/contact-us">
              ...
              <Div pb="15px" pl="25px">
                <Link to="/who-we-are">
                  <Text style={{ letterSpacing: '1.28px' }}>About Us</Text>
                </Link>
              </Div>
            </Div>
          </Div>
