...
@connect(({ reclinerlanding }) => ({
  reclinerlanding,
  textBanner: reclinerlanding.data.items.text.textBanner,
  bedBanner: reclinerlanding.data.items.text.bedBanner,
  stripes: reclinerlanding.data.items.text.stripes,
  offerBanner: reclinerlanding.data.items.text.offerBanner,
  duracucine: reclinerlanding.data.items.text.duracucine,
  bankOffer: reclinerlanding.data.items.text.bankOffer,
  whyUs: reclinerlanding.data.items.text.whyUs,
  store: reclinerlanding.data.items.text.store,
  solidbeds: reclinerlanding.data.items.text.solidbeds
}))
class ReclinerLandingContainer extends Component {
  render() {
...
export default ReclinerLandingContainer;
