...
export default class KitchenWareContainer extends Component {
  getBgColor = comp => {
    switch (comp) {
      case 9:
        return "#F5F5F5";
      ...
      <Section p="0" mb="0">
        <div className="wrapper">
          ...
          <div className={styles.BreadCrumb_wrapper_main}>
            <BreadCrumb urlKey="kitchenware" name={pageTitle} />
          </div>
...
KitchenWareContainer.defaultProps = {
  category: [],
  seoInfo: {
    seo_text: ""
  }
...
KitchenWareContainer.propTypes = {
