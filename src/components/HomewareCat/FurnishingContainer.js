...
export default class FurnishingContainer extends Component {
  getBgColor = comp => {
    switch (comp) {
      case 9:
        return "#F5F5F5";
      ...
      <Section p="0" mb="0">
        <div className="wrapper">
          ...
          <div className={styles.BreadCrumb_wrapper_main}>
            <BreadCrumb urlKey="home-furnishings" name={pageTitle} />
          </div>
...
FurnishingContainer.defaultProps = {
  category: [],
  seoInfo: {
    seo_text: ""
  }
