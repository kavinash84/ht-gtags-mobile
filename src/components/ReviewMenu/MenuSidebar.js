...
// import { walletPopup } from "redux/modules/profile";

const BackIcon = require("../../../static/onelacPackage/new_back.svg");
const SearchIcon = require("../../../static/search-icon.svg");
// const LogoIcon = require("../../../static/logo3x.png");
const LogoIcon = require("../../../static/logo3x.png");
const CartIcon = require("../../../static/Review/cartIcon.svg");
...
const Reviewtopleft = require("../../../static/Review/reviewtopleft.svg");
const WhishlistIcon = require("../../../static/Review/whishlistIcon.svg");
const ProfileIcon = require("../../../static/Review/profileIcon.svg");
...
@connect(
  ({ userLogin, wishlist, profile, homepage, cart, pincode, router }) => ({
    ...
    router,
    openWalletPopup: profile.openWalletPopup
  }),
  null
)
@withRouter
export default class MenuSidebar extends Component {
  ...
  //   this.setState({
  //     openWalletPopupState: false
  //   });
  //   dispatch(walletPopup(false));
  // };
            ...
            >
              ...
              {menuIcon && (
                <div className={styles.barContainer2}>
                  ...
                  >
                    <Img src={Reviewtopleft} alt="Side Menue" />
                  </span>
                </div>
              )}
            ...
            {!hideright && (
              <Div col="8" ta="right" pt="16px" className={styles.rightBLock}>
                ...
                <Link
                  p="0"
                  className={styles.cart}
                  to={isLoggedIn ? MY_PROFILE_URL : LOGIN_URL}
                >
                  <Img
                    src={ProfileIcon}
                    alt="Cart"
                ...
                {/* <a className={styles.cart} href="tel:1800-210-0004">
                  <Img
                    src={PhoneIcon}
                    alt="Hometown"
                    height="22px"
