...
class WelcomeHomeOld extends Component {
      ...
      const { mainBanner, offerBanner, mainOffers, duracucine, bankOffer, whyUs, store } = this.props;
        return ( 
            <Section p="0px" mb="0.5rem">
             ...
             {offerBanner && (
              <Div>
             <Image width="70%" mt="15px" ml="15%" src={offerBanner.image}  alt="Mid banner"/>
             </Div>
               )}

             <Row justifyContent="center" ml="-10px" mr="-10px" pt="20px">
            ...
            <Div
               ...
               width={1}
            >
             <Image src={slide.offer} alt='offer' height="auto" width="95%" />
           </Div>
           </Div>
             ))}
           </Row>
           ...
           {duracucine &&(
             ...
             {whyUs && (
              <Div>
                 <Image width="100%" height="auto" pl="5%" pr="5%" mt="10px" src={whyUs.image} alt="whyus banner"/>
             </Div>
             )}
