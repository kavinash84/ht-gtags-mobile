const NOTIF_SEND = 'notify/NOTIF_SEND';
const NOTIF_DISMISS = 'notify/NOTIF_DISMISS';
const NOTIF_CLEAR = 'notify/NOTIF_CLEAR';
const NOTIF_CLEAR_ALL = 'notify/NOTIF_CLEAR_ALL';
